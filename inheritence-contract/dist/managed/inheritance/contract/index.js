...
export class Contract {
    ...
    constructor(...args_0) {
        ...
        this.circuits = {
            register: (...args_1) => {
                ...
                const parent_addr_0 = args_1[1];
                const child_addr_0 = args_1[2];
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('register', 'argument 1 (as invoked from Typescript)', 'inheritence.compact line 12 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(parent_addr_0.buffer instanceof ArrayBuffer && parent_addr_0.BYTES_PER_ELEMENT === 1 && parent_addr_0.length === 32)) {
                    __compactRuntime.typeError('register', 'argument 1 (argument 2 as invoked from Typescript)', 'inheritence.compact line 12 char 1', 'Bytes<32>', parent_addr_0);
                }
                if (!(child_addr_0.buffer instanceof ArrayBuffer && child_addr_0.BYTES_PER_ELEMENT === 1 && child_addr_0.length === 32)) {
                    __compactRuntime.typeError('register', 'argument 2 (argument 3 as invoked from Typescript)', 'inheritence.compact line 12 char 1', 'Bytes<32>', child_addr_0);
                }
                const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
                const partialProofData = {
                    input: {
                        value: _descriptor_1.toValue(parent_addr_0).concat(_descriptor_1.toValue(child_addr_0)),
                ...
                const result_0 = this._register_0(context, partialProofData, parent_addr_0, child_addr_0);
                partialProofData.output = { value: [], alignment: [] };
                return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
            },
            execute: (...args_1) => {
                if (args_1.length !== 1) {
                    throw new __compactRuntime.CompactError(`execute: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
                }
                const contextOrig_0 = args_1[0];
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('execute', 'argument 1 (as invoked from Typescript)', 'inheritence.compact line 22 char 1', 'CircuitContext', contextOrig_0);
                }
                const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
                const partialProofData = {
                ...
                const result_0 = this._execute_0(context, partialProofData);
                partialProofData.output = { value: [], alignment: [] };
                return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
            }
        };
    ...
    _register_0(context, partialProofData, parent_addr_0, child_addr_0) {
        ...
        const p_0 = parent_addr_0;
        const c_0 = child_addr_0;
        __compactRuntime.queryLedgerState(context, partialProofData, [
            { push: { storage: false,
                    value: __compactRuntime.StateValue.newCell({ value: _descriptor_6.toValue(0n),
                        alignment: _descriptor_6.alignment() }).encode() } },
    ...
    _execute_0(context, partialProofData) {
        __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
            { dup: { n: 0 } },
            { idx: { cached: false,
                    pushPath: false,
