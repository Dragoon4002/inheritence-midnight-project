...
const InheritancePrivateStateId = 'inheritancePrivateState';
// ---------------------------------------------------------------------------
...
async function main() {
    ...
    // --- Compile contract ---
    const inheritanceCompiledContract = CompiledContract.make('inheritance', Contract).pipe(CompiledContract.withVacantWitnesses, CompiledContract.withCompiledFileAssets(zkConfigPath));
    // --- Deploy ---
